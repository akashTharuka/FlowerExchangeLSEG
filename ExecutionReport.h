...
class ExecutionReport
{
	public:
		...
		ExecutionReport(std::string client_order_id, std::string instrument, int side, double price, int quantity, int status, std::string reason = "", std::string transaction_time);
		~ExecutionReport();
